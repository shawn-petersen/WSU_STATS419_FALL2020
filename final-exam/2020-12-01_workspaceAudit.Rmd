---
title: 'R Notebook: Workspace Audit for Shawn Petersen'
output:
  html_document:
    df_print: paged
    toc: true
...
Browse to <https://github.com/shawn-petersen/WSU_STATS419_FALL2020/graphs/code-frequency> where you replace my repository name with yours.  Screenshot and include the graphic in this folder, named "github-code-frequency.png".

<IMG src='github-code-frequency.png' style="border: 2px black solid;" />
<div>**Source: <a href="https://github.com/shawn-petersen/WSU_STATS419_FALL2020/graphs/code-frequency">GitHub</a>**</div>


### Commit Frequency on GitHub
Browse to <https://github.com/shawn-petersen/WSU_STATS419_FALL2020/graphs/commit-activity> where you replace my repository name with yours.  Screenshot and include the graphic in this folder, named "github-commits.png". 

<IMG src='github-commits.png' style="border: 2px black solid;" />
<div>**Source: <a href="https://github.com/shawn-petersen/WSU_STATS419_FALL2020/graphs/commit-activity">GitHub</a>**</div>
...
Hello Professor Shaffer, for the workspace audit, I used Dropbox, your YouTube channel when new videos were posted and Git only during the weeks it was shown to our class during the first part of the semester. I have Dropbox installed, since I use it for personal and school purposes but the `which Dropbox` command was unable to find its installation on my Windows 10 PC. I have a personal Github account that I used for some of the class content, mid-term and final, but didnt use the "WSU_STATS419_FALL2020" folder as often as I should have. I use Git and Gitlab daily at my employment and use collaboratively with many team members across the organization so Im aware of its capabilities, especially with software development. 

* The first set of graphs they show the 'code frequency', how many files, inserts, deletes were done over the course of the year, by day 1-365, for the Github repository

* The second set of graphs, show my local Git repository activity 

* For my work habits, I believe this is where I excelled. I work full-time but routinely wake up at 5am, log into all my classes to review any discussions, posts, and emails. During the day at work, during my lunch break, I do the same for all my classes and write down a list of "to-do's". This list prepped me for the evening on actions to complete. I would watch videos, complete necessary homework in the Notebooks, add code in the notebooks to see additional results of your datasets provided.

I deserve 48/50 points because I was developing++ in this class and a master of these tools at my employment. I have a good grasp on  the R workspace and mastery level in the use of Git/Github.
